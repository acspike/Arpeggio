...
#mode Patterns
from six_scales import scales


doc = SimpleDocTemplate("six_scales.pdf",  pagesize=letter, bottomMargin = 0.25*inch, topMargin = 0.75*inch)
story = []
count = 0
for title, notes in scales:
    if title == '5th String 4th Finger':
